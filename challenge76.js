/* Description 7kyu //The Poet And The Pendulum
Scenario
...
function fromCenter(arr) {
  //   let s = [];
  let [arr1, arr2] = [[], []];
  let sort = arr.sort((a, b) => a - b);
  for (let i = 0; i < sort.length; i++) {
    i % 2 === 0 ? arr1.unshift(arr[i]) : arr2.push(arr[i]);
  }
  return [...arr1, ...arr2];
}
...
// }
console.log(fromCenter([11, -16, -18, 13, -11, -12, 3, 18])); //
console.log(fromCenter([-9, -2, -10, -6])); //[-6, -10, -9, -2];
console.log(fromCenter([-9, -2, 10, 6, 44, 78, -8, 1])); // [44, 6, -2, -9,-8, 1, 10, 78]
