/*Description 7kyu //Automorphic Number (Special Numbers Series #6)
Definition
...
function endWithNum(num) {
  let sqNum = num * num;
  return `${sqNum}`.endsWith(num) ? "Automorphic" : "Not!!";
}

console.log(endWithNum(25)); //Automorphic
console.log(endWithNum(88)); //Not!!
console.log(endWithNum(135)); //Not!!
console.log(endWithNum(76)); //Automorphic
