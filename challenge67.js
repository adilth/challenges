/* Description 7kyu //Strong Number (Special Numbers Series #2)
Definition
...
function getsumfactorDigits(n) {
  // if (n < 0) return null;
  let sum = [...String(n)].map(Number).reduce((a, b) => a + factorial(b), 0);
  return sum == n ? "STRONG!!!!" : "Not Strong !!";
}

console.log(getsumfactorDigits(145)); //STRONG!!!!
console.log(getsumfactorDigits(2)); //STRONG!!!!
console.log(getsumfactorDigits(36)); //Not Strong !!
